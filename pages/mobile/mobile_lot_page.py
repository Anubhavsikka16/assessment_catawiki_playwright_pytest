"""
Mobile Lot Page Module

Page Object Model for mobile lot details page.
...
class LotPage(BasePage):
    """Page Object for Mobile Lot Details Page."""

    LOT_NAME = "[class='LotTitle_container__N76Ob'][data-sentry-component='MobileLotTitle']"
    FAVORITES = "div[data-sentry-component='LotDetailsFavoriteButton'] [title='favourite']"
    CURRENT_BID = "div[class*='LotBidStatusSection'] [data-sentry-component='Amount']"
    ...
    def get_lot_details(self) -> dict:
        """
        Extract lot details from mobile lot page.
